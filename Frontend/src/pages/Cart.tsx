          ...
          <div className="lg:w-72">
            <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
              ...
              <div className="space-y-2 text-sm text-gray-600 mb-4">
                ...
                <div className="flex justify-between">
                  <span>Discount</span>
                  <span className="text-red-400">- Rs. 0</span>
                </div>
              </div>
              ...
              <button className="w-full bg-blue-600 text-white py-3 rounded-lg hover:bg-blue-700 active:scale-95 transition font-semibold">
                Checkout →
              </button>
